...
Inherits iOSLibSKNode
	...
	#tag Method, Flags = &h1000
		Sub Constructor(ImageName as CFStringRef, GenerateNormalLightingMap as Boolean = false)
		  ...
		  Super.Constructor (spriteNodeWithImageNamed (classptr, ImageName, GenerateNormalLightingMap))
		  RetainClassObject
		End Sub
	#tag EndMethod
