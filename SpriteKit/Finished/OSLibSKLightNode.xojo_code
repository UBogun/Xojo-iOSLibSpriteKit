	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return new iOSLibColor (ambientColor(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return new iOSLibColor (lightColor(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return new iOSLibColor (shadowColor(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
