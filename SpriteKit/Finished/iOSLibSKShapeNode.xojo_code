	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKShader.MakeFromPtr (fillShader (id))
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKShader.MakeFromPtr (strokeShader (id))
		...
		#tag Setter
			...
			End Set
		#tag EndSetter
		StrokeShader As iOSLibSKShader
	#tag EndComputedProperty
