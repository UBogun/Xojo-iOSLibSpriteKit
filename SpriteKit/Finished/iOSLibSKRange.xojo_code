...
Inherits iOSLibObject
	...
	#tag Method, Flags = &h0
		 Shared Function MakefromPtr(aPtr as Ptr) As iOSLibSKRange
		  return if (aptr = nil, Nil, new iOSLibSKRange (aptr))
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		 Shared Function WithConstantValue(ConstantValue as Double) As iOSLibSKRange
		  ...
		  #endif
		  result = new iOSLibSKRange (rangeWithConstantValue(ClassPtr, ConstantValue))
		  result.RetainClassObject
		  return result
	...
	#tag Method, Flags = &h0
		 Shared Function WithLowerLimit(LowerLimit as Double) As iOSLibSKRange
		  dim result as iOSLibSKRange
		  #if Target64Bit
		  ...
		  #endif
		  result = new iOSLibSKRange (rangeWithLowerLimit(ClassPtr, LowerLimit))
		  result.RetainClassObject
		  return result
	...
	#tag Method, Flags = &h0
		 Shared Function WithUpperLimit(UpperLimit as Double) As iOSLibSKRange
		  dim result as iOSLibSKRange
		  #if Target64Bit
		  ...
		  #endif
		  result = new iOSLibSKRange (rangeWithUpperLimit(ClassPtr, UpperLimit))
		  result.RetainClassObject
		  return result
