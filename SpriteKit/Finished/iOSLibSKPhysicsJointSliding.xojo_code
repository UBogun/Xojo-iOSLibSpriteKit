#tag Class
Protected Class iOSLibSKPhysicsJointSliding
Inherits iOSLibSKPhysicsJoint
	#tag Method, Flags = &h1000
		Sub Constructor(BodyA As iOSLibSKPhysicsBody, BodyB as iOSLibSKPhysicsBody, Anchor as NSPoint, Axis as CGVector)
		  #if Target64Bit
