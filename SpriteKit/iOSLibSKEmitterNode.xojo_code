#tag Class
Protected Class iOSLibSKEmitterNode
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Return iOSLibSKAction.MakeFromPtr (particleAction(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
			...
			End Set
		#tag EndSetter
		ParticleAction As iOSLibSKAction
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  Return iOSLibColor.MakeFromPtr (particleColor(id))
			End Get
		#tag EndGetter
		#tag Setter
			Set
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKTexture.MakeFromPtr (particleTexture (id))
		...
		#tag Setter
			...
			End Set
		#tag EndSetter
		ParticleTexture As iOSLibSKTexture
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKShader.MakeFromPtr (shader (id))
	...
	#tag ComputedProperty, Flags = &h0
		#tag Getter
			Get
			  ...
			  return iOSLibSKNode.MakeFromPtr (targetNode (id))
